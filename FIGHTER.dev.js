...
console.log("Testing!"); //JS will include:
...
var playerTwoHPBar = document.querySelector(".playertwo__HP"); //Fighter Class. Functions for losing HP, gaining Energy, and losing Energy.
...
var playerTwo = new Fighter(playerTwoHPBar);
playerOne.deductHP();
